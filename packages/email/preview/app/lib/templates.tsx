...
export const templates: Record<string, TemplateDefinition> = {
  ...
  'document-invite': {
    ...
    fields: {
      ...
      inviterEmail: { type: 'text', label: 'Inviter email', default: 'lucas@open-mic.co.za' },
  ...
  'document-rejected': {
    ...
    fields: {
      recipientName: recipientNameField,
      documentName: documentNameField,
      documentUrl: { type: 'text', label: 'Document URL', default: 'https://agreements.open-mic.co.za' },
      rejectionReason: {
        type: 'textarea',
  ...
  'organisation-invite': {
    ...
    fields: {
      ...
      organisationName: { type: 'text', label: 'Organisation name', default: 'Open Mic Productions' },
    },
  },
  'organisation-join': {
  ...
  'confirm-team-email': {
    ...
    fields: {
      teamName: { type: 'text', label: 'Team name', default: 'Open Mic Productions' },
    },
  },
  'team-delete': {
    name: 'Team delete',
  ...
  'team-email-removed': {
    ...
    fields: {
      teamName: { type: 'text', label: 'Team name', default: 'Open Mic Productions' },
      teamEmail: { type: 'text', label: 'Team email', default: 'team@open-mic.co.za' },
    },
  },
  ...
  'confirm-email': {
    ...
    fields: {
      confirmationLink: {
        ...
        default: 'https://agreements.open-mic.co.za/confirm',
      },
    },
  },
  'forgot-password': {
    ...
    fields: {
      resetPasswordLink: {
        type: 'text',
        label: 'Reset link',
        default: 'https://agreements.open-mic.co.za/reset',
      },
    },
  },
  'reset-password': {
    ...
    fields: {
      userName: { type: 'text', label: 'User name', default: 'Lucas Smith' },
      userEmail: { type: 'text', label: 'User email', default: 'lucas@open-mic.co.za' },
    },
  },
  'access-auth-2fa': {
