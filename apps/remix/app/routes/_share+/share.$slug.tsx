...
export function meta({ params: { slug } }: Route.MetaArgs) {
  ...
  return [
    { title: 'Open Mic Productions - Share' },
    { description: 'I just signed a document in style with Open Mic Productions!' },
    {
      property: 'og:title',
      content: 'Open Mic Productions - Secure digital signing',
    },
    {
      property: 'og:description',
      content: 'I just signed with Open Mic Productions!',
    },
    {
      property: 'og:type',
      content: 'website',
...
export const loader = async ({ request, params: { slug } }: Route.LoaderArgs) => {
  ...
  // Is hardcoded because this whole meta is hardcoded anyway.
