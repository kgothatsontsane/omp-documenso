  ...
  return (
    <div>
      <article className="prose dark:prose-invert">
        ...
        <p>
          <Trans>
            Thank you for using Open Mic Productions to perform your electronic document signing. The purpose of this
        ...
        <p>
          <Trans>
            By proceeding to use the electronic signature service provided by Open Mic Productions, you affirm that you
